		...
		<div class="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
			...
			<main>
              ...
              <div class="max-w-full overflow-x-auto">
                ...
                <div class="mb-6">
                  <label class="mb-2.5 block font-medium text-black dark:text-white">User Name</label>
                  <div class="relative">
                ...
                <div class="mb-5">
                  <button type="submit" value="Add"
                    class="w-full cursor-pointer rounded-lg border border-blue-500 bg-blue-500 p-4 font-medium text-white transition hover:bg-blue-600">Add</button>

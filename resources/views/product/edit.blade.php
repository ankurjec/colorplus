					...
					<div
						...
						<form action="{{ route('product.update', $product->id) }}" method="POST">
							...
							<div class="max-w-full overflow-x-auto">
								<div class="mb-6">
									<label class="mb-2.5 block font-medium text-black dark:text-white">Update
										product Name</label>
									<div class="relative">
								...
								<div class="mb-6">
									...
									<div class="relative">
										...
										<textarea name="details" rowspan="3"
											id="editor2">{{$product->details}}</textarea>
								...
								<div class="mb-6">
									<label class="mb-2.5 block font-medium text-black dark:text-white">Update
										Description</label>
									<div class="relative">
										<textarea name="description" rowspan="3"
									...
									<div class="flex">
										<div class="relative flex mr-4">
											<input type="checkbox" name="isPopularProduct"
												...
												value="1" {{ $isPopularProduct==1 ? 'checked' : '' }}>
										...
										<div class="relative flex">
											<input type="checkbox" name="isNewProduct"
												class="form-checkbox h-4 w-4 text-primary border-primary rounded focus:ring-primary"
												value="1" {{ $isNewProduct==1 ? 'checked' : '' }}>
